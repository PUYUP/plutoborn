...
from public.views.console.forms import (
...
class TheoryView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/theory.html'
    context = dict()
...
class TheoryEditorView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/theory-editor.html'
    context = dict()
    form = TheoryForm
...
class PacketView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/packet.html'
    context = dict()
...
class PacketEditorView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/packet-editor.html'
    context = dict()
    form = PacketForm
...
class QuestionView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/question.html'
    context = dict()
...
class QuestionEditorView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/question-editor.html'
    context = dict()
    form = QuestionForm
...
class BundleView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/bundle.html'
    context = dict()
...
class BundleEditorView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/bundle-editor.html'
    context = dict()
    form = BundleForm
...
class TopUpView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/topup.html'
    context = dict()
...
class TopUpDetailView(LoginRequiredMixin, View):
    ...
    template_name = 'templates/console/master/topup-detail.html'
    context = dict()
