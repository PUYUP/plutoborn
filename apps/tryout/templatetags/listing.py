...
def paginator_number(cl, i):
    ...
    """
    link_class = mark_safe(' class="page-link end"' if i == cl.paginator.num_pages - 1 else 'class="page-link"')
    page_var = get_query_string(cl, {PAGE_VAR: i})

    if i == DOT:
        return format_html('<li class="page-item disabled"><span class="page-link">...</span></li>')
    elif i == cl.page_num:
        return format_html(
